...
export default function Downloads(props) {
    return (
        <>
            <div class="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none pt-24 xl:col-span-6">
                <h1 class="text-4xl font-medium tracking-tight text-green-500">All of us can be curators of our own learning.</h1>
                <p class="mt-6 text-lg text-gray-600">
                    Stay up-to-date on industry standards and curated your own learning with our tools.</p>
